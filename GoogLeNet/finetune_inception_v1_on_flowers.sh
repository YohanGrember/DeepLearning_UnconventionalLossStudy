...
TRAIN_DIR=/tmp/flowers-models/inception_v1/surrogate_exponential
...
#for loss in 'hinge' 'crammer' 'lee' 'surrogate_hinge' 'surrogate_hinge_squares' 'surrogate_squares' 'surrogate_exponential' 'surrogate_sigmoid' 'surrogate_logistic' 'surrogate_double_hinge' 'GEL' 'GLL'
#do
