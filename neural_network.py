...
#choose parameters
DATASET='cifar10' #mnist / cifar10 / icml
LOSS='large-margin entropy' #entropy / hinge / crammer / lee / surrogate / GEL / GLL / large-margin entropy
BATCH_SIZE=5
ITERATION=1100
LAMBDA=0.5 #devant le terme de régularization
LEARNING_RATE=1e-4
FLAGS = None
